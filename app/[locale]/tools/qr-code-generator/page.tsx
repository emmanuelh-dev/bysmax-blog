...
const FULL_TITLE = `${TITLE} para whatsapp, contactos, teléfonos, emails, SMS, redes WiFi y más.`
const DESCRIPTION =
  'Generador de códigos QR gratuito y fácil de usar. Crea códigos QR personalizados para URLs, contactos, teléfonos, emails, SMS y redes WiFi.'
