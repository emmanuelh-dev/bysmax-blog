    ...
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a]">
      ...
      <Sidebar>
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-12">
            <ins
              className="adsbygoogle block h-[280px] w-full rounded-lg border border-[#e5e5e5] bg-[#f9f9f9] dark:border-[#333333] dark:bg-[#1a1a1a]"
              style={{ display: 'block' }}
                ...
                >
                  ...
                  <header className="mb-6">
                    ...
                    <div className="grid gap-4 md:grid-cols-3">
                      ...
                      <div>
                        <span className="text-sm font-medium text-[#737373]">Función Booleana</span>
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  ...
                  <div className="rounded-lg border border-[#e5e5e5] p-6 dark:border-[#333333]">
                    ...
                    <p className="text-sm leading-relaxed">
                      ...
                      <span className="font-medium">CMOS</span>, para ahorrar espacio y aumentar la
                      eficiencia.
                    </p>
                  </div>
                </div>
            ...
            <div>
              ...
              <div className="grid gap-4 md:grid-cols-3">
                {[
                  ...
                  >
                    <h3 className="mb-2 font-medium text-[#0a0a0a] dark:text-white">{item.name}</h3>
