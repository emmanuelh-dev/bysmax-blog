      ...
      <Sidebar>
        <div className="mx-auto max-w-4xl">
          ...
          <header className="mb-12">
            <h1 className="mb-6 text-center text-5xl font-semibold tracking-tight text-[#0a0a0a] dark:text-white">
              {ui.pageTitle}
            </h1>
                    ...
                    <div key={gate.url}>
                      <article className="rounded-lg border border-[#e5e5e5] bg-white p-6 transition-all duration-200 hover:border-[#0070f3] hover:shadow-sm dark:border-[#333333] dark:bg-[#0a0a0a] dark:hover:border-[#0070f3]">
                        ...
                        <div className="grid gap-6 lg:grid-cols-2">
                          {/* Truth Table */}
                          {gateTranslation.truthTable && gateTranslation.truthTable.length > 0 && (
                            <div>
                  ...
                  .map((gate) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <p className="text-sm text-[#737373]">{gateTranslation.applications[0]}</p>
                      </div>
                    )
                  })
                  .filter(Boolean)}
