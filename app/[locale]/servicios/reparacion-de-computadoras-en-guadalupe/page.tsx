...
export const metadata = genPageMetadata({
  ...
  description:
    'Servicio de Mantenimiento y Reparación de computadoras de alta calidad en Guadalupe.',
})

export default function Page() {
  return (
    <Reparacion site="Guadalupe">
      <Visitanos />
    </Reparacion>
  )
}
      ...
      <div className="space-y-6 md:space-y-8">
        <div className="">
          ...
          <p className="text-muted-foreground text-lg">
            Nuestra tienda está ubicada en el corazón de Guadalupe, ofreciendo un servicio cercano y
            de confianza.
          </p>
        </div>
