...
const images = [
  { src: '/static/images/multisim/1.jpg', alt: 'Descargar Proteus Imagen Circuito' },
  { src: '/static/images/multisim/2.jpg', alt: 'Descargar Proteus Virus Total Image 1' },
  { src: '/static/images/multisim/3.jpg', alt: 'Descargar Proteus Imagen Home' },
]
  ...
  const jsonLd = [
    {
      ...
      image: 'https://electronica.bysmax.com/static/images/multisim/1.jpg',
      name: 'NI Multisim',
      applicationCategory: 'BusinessApplication',
      downloadUrl: `https://electronica.bysmax.com/${locale}/software/mathcad-14`,
      description:
      ...
      softwareVersion: 'VERSIÓN_DEL_SOFTWARE',
      aggregateRating: {
