...
export default async function Software({ locale }) {
  ...
  return (
    <>
      <section id="programs" className="bg-muted py-12 ">
        <div className="">
            ...
            <div className="flex hidden items-center justify-between">
              ...
              <div className="relative max-w-md flex-1">
                ...
                <Input
                  ...
                  className="bg-background w-full rounded-md pl-8"
                />
              </div>
            </div>
      ...
      <section id="programs" className="bg-muted py-12 ">
        <div className="">
          <div className="mb-8 flex flex-col gap-4">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
              {t('softwaresTitleCreativos')}
            </h2>
            <p className="text-muted-foreground max-w-[700px] md:text-xl">
              {t('softawreDescriptionCreativos')}
            </p>
          </div>
          <div className="grid gap-6 md:gap-8">
            <div className="flex hidden items-center justify-between">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {(t('cardsCreativos', { returnObjects: true }) as unknown as any[]).map(
                (card, index) => (
                  <Card key={index}>
                    <CardHeader>
                      <CardTitle>{card.title}</CardTitle>
                    ...
                    <CardContent>
                      <div className="flex items-center justify-between">
                        ...
                        <Link
                          href={
                            card.link.startsWith('http') ? card.link : `/${locale}/${card.link}`
                          }
                          className={buttonVariants({ variant: 'default' })}
                        >
                          {card.linkText}
